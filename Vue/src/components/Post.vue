<template>
    <div>
      ...
      <!-- Create or Post -->
      <input type="text" v-model="title" placeholder="Enter Title" class="title-input">
      <input type="text" v-model="body" placeholder="Enter Body" class="body-input">

      <button v-if="isEditing" @click="updatePost">Update</button>
      <button v-if="isEditing" @click="cancelPost">Cancel</button>
